...
@section ('contenido')
	<div class="row">
		<div class="clas-lg-6 col-md-6 col-sm-6 col-xs-12">
			...
			{!!Form::open(array('url'=>'partner/usuario','method'=>'POST','autocomplete'=>'on'))!!}
			{{Form::token()}}
	<div class="row">
		...
		<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
			<div class="form-group">
				<label for="ape_pater">Apeli  ido Paterno</label>
		...
		<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
			<div class="form-group">
				...
				<input type="text" name="ape_mater" required value="{{old('ape_mater')}}" class="form-control" placeholder="Apellido Materno..">
			</div>			
		</div>
		<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
			<div class="form-group">
		...
		<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
			<div class="form-group">
				...
				<input type="text" name="num_doc" required value="{{old('num_doc')}}" class="form-control" placeholder="Numero de documento..">
			</div>			
		</div>
		<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
			<div class="form-group">
		...
		<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
			<div class="form-group">
				...
				<input type="text" name="tele" required value="{{old('tele')}}" class="form-control" placeholder="Numero de telefono..">
			</div>			
		</div>
		<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
			<div class="form-group">
		...
		<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
			<div class="form-group">
				<label for="tipo_per">Tipo Persona</label>
				<select name="tipo_per" id="tipo_per" required value="{{old('tipo_per')}}" class="form-control" >
