...
@section ('contenido')
	<div class="row">
		<div class="clas-lg-6 col-md-6 col-sm-6 col-xs-12">
			...
			{!!Form::open(array('url'=>'partner/tipopaquete','method'=>'POST','autocomplete'=>'off'))!!}
			{{Form::token()}}
	<div class="row">
		<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
			<div class="form-group">
				<label for="nom_paquete">Nombre</label>
				<input type="text" name="nom_paquete" required value="{{old('nom_paquete')}}" class="form-control">
			</div>			
		</div>
	</div>
	<div class='row'>
